...
let togglesign = document.querySelectorAll('.toggle_head');
let contentfaq = document.getElementsByClassName('toggle_content_wrapper');
let sign1 = document.querySelectorAll('.sig_1')
let sign2 = document.querySelectorAll('.sig_2')




        togglesign.forEach((e,index) => {
           e.onclick = () => {
                    contentfaq[index].classList.toggle('togglearea');
                     sign2[index].classList.toggle('signrotate')
