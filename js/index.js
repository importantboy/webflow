...
let mainhead= document.querySelector(".rotator-head");
...
let seventhone;
let eightone;
let animename = "rotateanime";
let milisec = 2500;

let createtime = () => {
  mainhead.children[0].classList.add(animename);
  another();
};

another = () => {
  x = setTimeout(function () {
    mainhead.children[0].classList.remove(animename);
    thirdone();
  }, milisec);
};

thirdone = () => {
  mainhead.children[1].classList.add(animename);
  forthone();
};

forthone = () => {
  x = setTimeout(function () {
    mainhead.children[1].classList.remove(animename);
    fifthone();
  }, milisec);
};

fifthone = () => {
  mainhead.children[2].classList.add(animename);
  sixthone();
};

sixthone = () => {
  x = setTimeout(function () {
    mainhead.children[2].classList.remove(animename);
    eightone();
  }, milisec);
};

eightone = () => {
  mainhead.children[3].classList.add(animename);
  lastone();
};

lastone = () => {
  x = setTimeout(function () {
    mainhead.children[3].classList.remove(animename);
    createtime();
  }, milisec);
};
